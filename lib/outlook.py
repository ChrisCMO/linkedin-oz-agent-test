...
class OutlookClient:
    def __init__(self):
        ...
        self.tenant_id = config.MICROSOFT_TENANT
        self.sender_email = config.MICROSOFT_SENDER_EMAIL
    ...
    def send_email(
        ...
        logger.error("Failed to send email (HTTP %d): %s", resp.status_code, resp.text)
    ...
    def test_connection(self) -> dict:
        ...
        raise Exception(f"Graph API test failed (HTTP {resp.status_code}): {resp.text}")
